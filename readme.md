...
Запрограммированная страница должна выглядеть в точности так, как на макете.
...
- Никнэйм:
  ...
  Заглавные и прописные символы не различаются, сохраняется в том регистре, в котором был введен.
